...
<div class="habitacion">
    ...
    <div class=" row justify-content-center align-items-center">
        <div class="card me-4" style="width: 30rem;">
            ...
            <div class="card-body">
                <a href="<?php echo e(route('data', ['adultos'=>$adultos,'menores'=>$menores,'fecha_ingreso' => $fecha_ingreso, 'fecha_salida' => $fecha_salida, 'habitacion' => 'Normal', 'valor' => $habitacion->precio_por_noche])); ?>" class="btn btn-primary custom_button">Habitación Normal</a>
            </div>
        </div>
        <div class="card ms-4" style="width: 30rem;">
            ...
            <div class="card-body">
                <a href="<?php echo e(route('data', ['adultos'=>$adultos,'menores'=>$menores,'fecha_ingreso' =>$fecha_ingreso, 'fecha_salida' =>$fecha_salida, 'habitacion' => 'Premium', 'valor' => $habitacion_p->precio_por_noche])); ?>" class="btn btn-primary custom_button">Habitación Premium</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Daniel\Desktop\hotel_laravel_test\resources\views/habitacion.blade.php ENDPATH**/ ?>
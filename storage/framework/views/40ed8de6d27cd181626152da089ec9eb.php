...
<!--@ dump($errors)-->
<form action="<?php echo e(route('ingreso', ['fecha_ingreso' =>$fecha_ingreso, 'fecha_salida' =>$fecha_salida, 'habitacion' => $habitacion])); ?>" method="POST" class="formulario">
    <?php echo csrf_field(); ?>
    <div class="form">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Daniel\Desktop\Hotel\hotel_laravel_test\resources\views/data.blade.php ENDPATH**/ ?>
...
<div class="habitacion">
    ...
    <div class=" row justify-content-center align-items-center">
        <div class="card me-4" style="width: 30rem;">
            ...
            <div class="card-body">
                <a href="<?php echo e(route('data')); ?>" class="btn btn-primary custom_button">Habitacion Normal</a>
            </div>
        </div>
        <div class="card ms-4" style="width: 30rem;">
            ...
            <div class="card-body">
                <a href="<?php echo e(route('data')); ?>" class="btn btn-primary custom_button">Habitacion Premium</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Daniel\Downloads\hotel_laravel_test\resources\views/habitacion.blade.php ENDPATH**/ ?>
...
<div>
    ...
    <div class="formulario">
        <div class="container mt-3">
            ...
            <br>
            <div class="boton">
                <a href="<?php echo e(route('habitaciones')); ?>" class="btn btn-primary custom_button">Siguiente</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Daniel\Downloads\hotel_laravel_test\resources\views/formulario.blade.php ENDPATH**/ ?>
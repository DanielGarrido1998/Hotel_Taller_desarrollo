...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-6 my-2">
                        ...
                        <input name="menores" class="form-control" type="number" placeholder="maximo 2" value="<?php echo e(old('infantes')); ?>">
                        <?php $__errorArgs = ['menores'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-6 my-2">
                        ...
                        <input name="fecha_ingreso" class="form-control" min="<?php echo e(now()->toDateString()); ?>" type="date" value="<?php echo e(old('fecha_ingreso')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-6 my-2">
                        ...
                        <input name="fecha_salida" class="form-control" min="<?php echo e(now()->toDateString()); ?>" type="date" value="<?php echo e(old('fecha_salida')); ?>" required>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Daniel\Desktop\hotel_laravel_test\resources\views/formulario.blade.php ENDPATH**/ ?>
...
<div>
    ...
    <div class="reserva">
        ...
        <div class="boton">
            <a href="<?php echo e(route('index.create')); ?>" class="btn btn-primary custom_button" style="background-color: rgb(151, 0, 113);border-color: rgb(151, 0, 113);">Reserva aqui!</a>
        </div>
    </div>
    <br>
    <br>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel_laravel_test\resources\views/index.blade.php ENDPATH**/ ?>